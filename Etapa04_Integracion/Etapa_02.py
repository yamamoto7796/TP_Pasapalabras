...
def seleccion_palabras_mayor_a_5(diccionario_seleccion):
    ...
    diccionario_2 = generar_diccionario(diccionario_seleccion)  #corregir nombre del parametro, la funcion recibe una lista, seria lista_seleccion
...
def contador_por_letra(diccionario_final_3):
    ...
    dicc_letras = {}
    for clave in diccionario_final_3.keys():
...
#esto vendria a ser la funcion de mostrar las letras
def mostrar_cant_palabras_y_cant_por_letra(diccionario_palabras) :
    #print(quitar_tilde(definiciones))
    print(f"Palabras en total: {contador_palabras_totales_diccionario(diccionario_palabras)}.")
    contador_por_letra(diccionario_palabras)
    print()
...
def obtener_diccionario() :
    definiciones = obtener_lista_definiciones()
    diccionario_palabras = quitar_tilde(definiciones)
    mostrar_cant_palabras_y_cant_por_letra(diccionario_palabras)
    return diccionario_palabras
"""    
def obtener_diccionario():
    definiciones = obtener_lista_deiniciones()
    diccionario_de_palabras = quitar_tilde(definiciones)
