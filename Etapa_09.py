from Etapa_07 import Lista_Jugadores
from Etapa_08_final import mostrar_diccionario_candidato
from Etapa_04_y_main import mostrar_bienvenida_juego,limpiar_pantalla
from Etapa_01 import obtener_palabra
...
def Crear_Lista_A_y_E(letras_seleccionadas):
    '''
    Esta funcion crea el tablero donde se veran los "A"(aciertos) y "E"(errores) de la partida.
    Autor:Facundo Cabral
    '''    
    lista_a_y_e = []
