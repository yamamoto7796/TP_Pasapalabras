...
def main():
    ...
    lista_letras = random.shuffle(Abecedario) #Se obtiene de funciones de la etapa 3
    ...
    Lista_deficiones = obtener_lista_definiciones() #Se obtiene de funciones de la etapa 3
    palabra_de_turno = Lista_deficiones[posicion_turno][SUBPOSICION_PALABRA_LISTA_DEFINICIONES]
    longitud_palabra_de_turno = len(palabra_de_turno)
    definicion_de_turno = Lista_deficiones[posicion_turno][SUBPOSICION_DEFINICION_LISTA_DEFINICIONES]
    lista_aciertos_y_errores = Creacion_lista_vacia_aciertos_y_errores(lista_letras)
    lista_palabras_ingresadas = []
    puntaje = 0
    Validacion_seguir_jugando = True
